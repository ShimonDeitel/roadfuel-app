...
struct SettingsView: View {
    ...
    @AppStorage("roadsidefuel_showNotes") private var showNotes: Bool = true
    @AppStorage("roadsidefuel_compactList") private var compactList: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/roadfuel-app/privacy.html")!)
                        .accessibilityIdentifier("settingsPrivacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/roadfuel-app/terms.html")!)
